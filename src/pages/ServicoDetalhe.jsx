            ...
            <div>
              <div className="backdrop-blur-xl rounded-3xl p-6 border border-white/10 bg-white/5 sticky top-28">
                ...
                <div className="flex gap-4">
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-[#25D366] text-white px-4 py-2.5 rounded-xl font-medium hover:scale-105 transition-transform flex items-center justify-center gap-2">
