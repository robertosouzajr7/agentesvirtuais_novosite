    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 max-w-xs">
              Especialistas em IA e automação, construindo experiências digitais
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 mb-4">
              <li>
                <a
                  href="mailto:suporte@agentesvirtuais.com"
                  className="hover:text-blue-500"
                >
                  suporte@agentesvirtuais.com
                </a>
              </li>
              <li>(71)9 9204-2802 (WhatsApp)</li>
        ...
        <div className="text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Agentes Virtuais. Todos os
            Direitos Reservados.
          </p>
        </div>
      </div>
